...
const Community: React.FC<BaseHomeProps> = () => {
  return (
    <>
      <section
        id="social"
      ...
      >
        <div className="flex max-xl:w-full max-xl:flex-col-reverse">
                ...
                <GridItem key={index} area={e.image}>
                  <Flex w={"100%"}>
                    <Link href={e.link} className="w-full" target="_blank">
                      <div
                        className="flex px-6 py-4 w-4/5 max max-xl:w-full rounded-[8px] item-redirect transition-all duration-300"
          ...
          <div className="w-full max-xl:w-full xl:w-1/2 animate__animated animate__zoomIn animate__delay-600ms">
