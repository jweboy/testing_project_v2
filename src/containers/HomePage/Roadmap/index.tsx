...
const Roadmap: React.FC<BaseHomeProps> = (props) => {
  const roadmap = [
    {
      name: "q1",
      precious: "Q3, 2023",
  ...
  return (
    ...
    >
      <div className="flex max-lg:flex-col justify-between mb-10">
        <div
          className={clsx(
            "w-5/12 max-lg:w-full",
            props.isActive && "animate__animated animate__lightSpeedInLeft"
          )}
        >
          <Typography
            type="body1-r"
        ...
        <div className="flex w-5/12 max-lg:w-full max-lg:mt-[24px] max-lg:justify-start justify-end">
          <Image
            ...
            className={clsx(
              "w-5/12 max-lg:w-full",
              props.isActive && "animate__animated animate__lightSpeedInRight"
            )}
          />
        </div>
      </div>
          ...
          return (
            <GridItem
              ...
              className={clsx(
                "w-full min-w-[25%]",
                props.isActive &&
                  `animate__animated animate__slideInUp animate__delay-${
                    500 * (index + 1)
                  }ms`
              )}
            >
