...
const TeamMember: React.FC<BaseHomeProps> = ({ isActive }) => {
  const member = [
    {
      name: "q1",
      nameMenber: "Edwin",
  ...
  return (
    ...
    >
      <div className="flex max-lg:flex-col justify-between mb-10">
        <div
          className={clsx(
            ...
            isActive &&
              "animate__animated animate__lightSpeedInLeft  animate__delay-300m"
          )}
        >
          <Typography
            type="body1-r"
      ...
      <div
        className={clsx(
          "block max-md:block max-xl:hidden",
          isActive && "animate__animated animate__zoomIn animate__delay-900ms"
        )}
      >
